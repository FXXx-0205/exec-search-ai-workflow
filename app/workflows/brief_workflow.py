...
from app.models.auth import AccessContext, MANAGER_ROLES
...
class BriefWorkflow:
    ...
    def _get_tenant_brief(self, brief_id: str, user: AccessContext):
    ...
    def _audit(self, event_type: str, action: str, brief, user: AccessContext, notes: str | None) -> None:
        self.audit.log(
            AuditEvent(
